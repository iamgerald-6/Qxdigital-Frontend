    ...
    <>      
        <div>  
            ...
            <div className='grid lg:grid-cols-3'>
                <div className='border mt-5 h-[44vh] flex justify-center flex-col items-center rounded-tr-[48px] lg:col-span-1 shadow-md shadow-slate-800'>
                    ...
                    <button  className='w-[40vw] lg:w-[27vw] text-center shadow-md shadow-orange-300 mt-4 py-2 border uppercase hover:bg-orange-50 transition ease-out font-family duration-300 flex justify-evenly'>Messages <BsFillChatDotsFill className='ms-12 mt-1'/></button>
